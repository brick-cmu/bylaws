...
\begin{enumerate}
  ...
  \item If a voting member is (i) not a chair of any committees and (ii) is not an officer, for the full duration of one academic semester, at the start of the following academic semester the voting member shall lose voting membership.  
