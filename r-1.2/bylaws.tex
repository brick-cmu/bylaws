...
\begin{enumerate}
  ...
  \item \textbf{Collective organization:} The collective organization shall be defined as the organization's general membership, in contrast to any of its specific committees or working groups.
  ...
  \item \textbf{Committee:} A committee shall be defined as a group which coordinates activities relating to a specific and narrow purpose. This definition is duplicated in section 6.1 ("structure of committees").
  \begin{enumerate}
    \item \textbf{Special committee:} In the context of working groups, a special committee shall be defined as the singular committee which is responsible for coordinating the working group's various committees. The special committee may also carry out actions not delegated to any specific committee in the working group. This definition is duplicated in section 7 ("working groups").
  \end{enumerate}
  \item \textbf{Committee meeting:} A committee meeting shall be defined as a meeting at which one-half or more of a committee's chairs are present and which all at-large members of the committee may attend as a right of membership. This definition is duplicated in section 6.5 ("committee meetings").
  ...
  \item \textbf{Working group:} A working group shall be defined as an organized group of committees operating under a special committee. The purpose of working groups is to facilitate coordination among multiple committees working on independent parts of a broader initiative. This definition is duplicated in section 7 ("working groups").
...
\subsubtab{Transfer of positions}
...
A committee shall be defined as a group which coordinates activities relating to a specific and narrow purpose (this definition is duplicated in section 2, "definitions").

Committees shall formally consist of a small number of chairs initially chosen by the collective organization, who may oversee a broader committee membership. Committees must meet regularly.

Two types of committees shall exist: short-term committees, with time-sensitive purposes, and long-term committees, with relevance which will continue indefinitely or near-indefinitely. Short-term committees shall have limited lifespans.
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \end{enumerate}
    \item Whether it will be a short-term or long-term committee. If it will be a short-term committee, its initial lifespan must be specified. The lifespan may be tied to (i) a finite duration, (ii) a specific expiry date, or (iii) a specific event or occurrence after which the committee will expire. The lifespan may not exceed 112 days (16 weeks), unless the resolution includes a clause permitting a longer maximum duration.
    \item Optionally, a clause increasing the maximum duration of the committee's lifespan to up to 365 days, if it is a short-term committee.
    \begin{enumerate}
...
\begin{enumerate}
  ...
  \item A short-term committee may change its lifespan, providing that it does not exceed the committee's maximum lifespan.
  ...
  \begin{enumerate}
    ...
    \item The maximum lifespan of a short-term committee, up to no more than 365 days.
  \end{enumerate}
  \item A supermajority resolution through the collective organization may directly alter any of the following:
  \begin{enumerate}
    \item The chairs of a committee.
    \item The lifespan of a committee.
  \end{enumerate}
  \item A supermajority resolution through the collective organization may force a committee's chairs to be re-selected by the full process or by directly proceeding to a ranked choice formal vote ballot item.
  \item A committee may opt to dissolve itself.
  \item A supermajority resolution may dissolve a committee.
\end{enumerate}

\subtab{Re-selection of long-term committee chairs}

The chairs of long-term committees must be re-selected, at minimum, once per fall semester and once per spring semester. Re-selection shall occur by the same mechanism as initial selection of chairs, as outlined in section 6.2 ("committee formation"). Re-selection should occur at the COM prior to the semesterly general election, such that if any committees' chair positions go to a ranked choice formal vote ballot item, the ballot item will be placed on the same formal vote as the organization's officer positions.
...
\begin{enumerate}
  ...
  \item Committees are encouraged to make meetings open to the collective organization's membership, and committees which choose to do so should announce meetings in such a manner that it can be reasonably expected that any member of (i) a working group which the committee is a part of or (ii) any member of the collective organization will be aware of the time and location of the meeting.
\end{enumerate}

\tab{Working groups}

\begin{enumerate}
  \item A working group shall be defined as an organized group of committees operating under a special committee. The purpose of working groups is to facilitate coordination among multiple committees working on independent parts of a broader initiative. This definition is duplicated in section 2 ("definitions").
  \item In the context of working groups, a special committee shall be defined as the singular committee which is responsible for coordinating the working group's various committees. The special committee may also carry out actions not delegated to any specific committee in the working group. This definition is duplicated in section 2 ("definitions").
  \item A working group must be created through the following process:
  \begin{enumerate}
    \item A simple resolution to create the working group must pass. This resolution must include its name, purpose, and date of creation, if not immediately as of its passing.
    \item The working group's special committee must be created following the process outlined in section 6.2 ("committee formation").
  \end{enumerate}
  \item Committees may be added to a working group through the consent of both the committee's chairs and the working group special committee's chairs.
  \begin{enumerate}
    \item If the chairs of the committee or working group special committee disagree internally on the addition of the committee to a working group, any chair may present a written petition for a vote, which shall require a written supermajority to pass.
  \end{enumerate}
  \item Committees may be removed from a working group by either the committee's chairs or the working group special committee's chairs.
  \begin{enumerate}
    \item If the chairs of the committee or working group special committee disagree internally on the removal of the committee from a working group, any chair may present a written petition for a vote, which shall require a written weak majority to pass.
  \end{enumerate}
  \item A supermajority of the non-special committees in a working group may present written majority votes among their respective chairs to (i) change the chairs of the special committee, (ii) force the chairs of the special committee to be re-selected at the next COM, or (iii) force the chairs of the special committee to be re-selected via a ranked choice formal vote ballot item.
  \item A working group shall dissolve upon the dissolution of its special committee.
\end{enumerate}
