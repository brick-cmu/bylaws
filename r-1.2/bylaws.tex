...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item Individuals shall assume their officer positions immediately following the conclusion of vote counting, unless both the newly elected individual and the current officer board consent to deferring to no later than the first day of the next fall or spring semester.
  \end{enumerate}
\end{enumerate}
