...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item \textbf{Simple resolution:} A simple resolution or majority resolution shall be defined as a resolution which may be passed by acclamation, by a supermajority show-of-hands vote during a collective organization meeting, or by a majority formal vote ballot item.  
...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item The collective organization may override this requirement conditionally or for specific individuals, possibly subject to some specified time constraint. No resolution may override ineligibility due to suspension.  
  ...
  \begin{enumerate}
    ...
    \item Any individual who is eligible for membership must be able to complete onboarding, and to do so within a reasonable time period. An individual may only be rejected from the onboarding process through the formal process of suspension.  
  \end{enumerate}
  \item In order for a non-voting member to become a voting member, they must (i) become a member of a committee or (ii) become an officer.  
  \item If a voting member is (i) not in any committees and (ii) is not an officer, for the full duration of one academic semester, at the start of the following academic semester the voting member shall lose voting membership.  
...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item Only voting members shall have the right to participate in votes by acclamation or in show-of-hands votes on resolutions.  
  \end{enumerate}
  \item All voting and non-voting members shall have the right to join any and all interest groups.  
  \item All voting and non-voting members shall have the right to committee candidacy.  
...
\begin{enumerate}
  \item The terms "suspended", "barred", "expelled", and "prohibited", any of which may be followed by "from membership", shall refer to an identical status, which shall be referred to in these bylaws as suspension. A suspended individual shall be prohibited from membership in the organization throughout the duration of the period of their suspension, which may be indefinite. This definition is duplicated in section 2 ("definitions").  
  \begin{enumerate}
  ...
  \end{enumerate}
  \item Membership may be suspended (i) for a set period of time, (ii) conditionally, or (iii) indefinitely; or suspension may be altered or undone; by a written majority vote of the officer board.  
  \begin{enumerate}
    \item No prior membership shall be required as a precondition to suspension.  
    \item If the member to be suspended is an officer, removal shall occur by a written supermajority vote of the other officers.  
  \end{enumerate}
  \item If an officer is suspended, they are immediately removed from their officer position(s), which then become vacant.
\end{enumerate}
...
There may be multiple clerks at any given time. Clerks are responsible for chairing and overseeing collective organization meetings, with the objective of neutrally conducting business and giving all attendees an equitable chance to be heard. Clerks must follow all rules governing COMs which are instituted through resolutions of the collective organization. Clerks are also responsible for ensuring minutes are taken at such meetings. The minutes-taker(s) must take care to record discussion in a neutral manner.

\subsubtab{Finance contact point}

The finance contact point is responsible for overseeing the budget and finances of the organization, including any financial responsibilities imposed by CMU or Student Government. The finance contact point is not responsible for approving or denying spending by the organization; the finance contact point must respect the resolutions of the collective organization.
...
The logistics contact point is responsible for:

\begin{enumerate}
  \item Overseeing space access for the organization.  
  \item The reserving of rooms or locations for the organization's use.  
  \item The storing and transporting of possessions of the organization.
\end{enumerate}
...
Officer positions must only be filled through one of two processes:

\begin{enumerate}
  \item General elections, during which the full officer board is re-selected.  
  \begin{enumerate}
    \item Precisely one general election must occur during each fall semester. The fall election must occur no earlier than the first Friday after fall break and no later than the second-to-last Friday of the semester, if reasonably possible.  
    \begin{enumerate}
      \item Elected individuals shall assume their officer positions at the start of the spring semester.  
      \item Any officer positions not filled by the fall general election shall become vacant at the start of the spring semester.  
    \end{enumerate}
    \item Precisely one general election must occur during each spring semester. The spring election must occur no earlier than the first Friday after spring break and no later than the second-to-last Friday of the semester, if reasonably possible.  
    \begin{enumerate}
      \item Elected individuals shall assume their officer positions at the start of the summer 1 semester, unless both the newly elected individual and the current officer board consent to deferring to no later than the first day of the upcoming fall semester.  
      \item Any officer positions not filled by the spring general election shall become vacant at the start of the summer 1 semester, unless both the individual holding the position and the incoming officer board consent to deferring the vacating of the position to no later than the first day of the upcoming fall semester.  
    \end{enumerate}
    \item General elections may not occur at any other time.  
  \end{enumerate}
  \item Special elections, during which only vacant officer positions are filled.  
  \begin{enumerate}
    \item Individuals shall assume their officer positions immediately following the conclusion of vote counting, unless both the newly elected individual and the current officer board consent to deferring for to no later than the first day of the next academic semester.
  \end{enumerate}
\end{enumerate}
...
If an officer position is vacant, the duties of the position should be distributed among other officers. A special election for any vacant positions must be scheduled as soon as is reasonably possible, unless a general election is to be scheduled within this time period.
...
\begin{enumerate}
  ...
  \item A supermajority resolution may be passed by the collective organization with a minimum notice period of 72 hours, scheduled no more than 7 days from the introduction of the proposed resolution if reasonably possible.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item The collective organization shall have the right to pass simple resolutions to oversee the scheduling of formal votes, to oversee the composition of voting boards, and to call for referendum ballot items. This is a delegable right.  
...
\begin{enumerate}
  ...
  \item During academic semesters, a COM must be scheduled no further than 14 days from the previous COM, if in that semester one or more COMs have occurred. A COM must be scheduled within the first 14 days of every academic semester, and within the last 14 days of every academic semester. The recommended spacing of COMs is 7 days.  
  \item COMs should be scheduled during times outside academic semesters as required.  
  ...
  \begin{enumerate}
    ...
    \end{enumerate}
    \item Committee reports, during which any information relevant to the collective organization relating to committees' activities must be related by a member of that committee, or by another individual if no such committee member is present.  
    \begin{enumerate}
      \item Any expiration, dissolution, or changes to name, purpose, membership, or lifespan of any committee during the period since the last COM must be reported during committee reports.  
    \end{enumerate}
  ...
  \begin{enumerate}
    \item Introductions by all individuals present, which should include a name, pronouns, committee membership, and any officer positions held.  
...
\begin{enumerate}
  ...
  \item A simple resolution may be passed through a supermajority show-of-hands vote during a collective organization meeting Clerks shall be in charge of counting votes and ensuring voting members are given sufficient time, at minimum five seconds, to raise and lower hands.  
  ...
  \begin{enumerate}
    ...
    \item The formal vote shall be scheduled no more than 7 days later if reasonably possible.  
...
A committee shall be defined as a small group of members which coordinate activities relating to a specific, narrow purpose (this definition is duplicated in section 2, "definitions"). Committees shall have a limited lifespan. Committees are not expected to include all members of the collective organization with an interest in their focus; rather, they have a duty to listen to and to represent such individuals.
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Its fixed size for ranked choice selection of initial members.  
    \begin{enumerate}
      \item The recommended size is between 3 and 7 individuals. The size must not be fewer than 2 individuals. The size must not be more than 8 individuals, unless the resolution includes a clause permitting a larger maximum size.  
    \end{enumerate}
    \item Optionally, a clause increasing the maximum size of the committee's membership, which may be no more than 16 individuals. Such a clause requires the resolution to pass by a majority vote.  
    \begin{enumerate}
      \item The initial size of the committee may be smaller than this bound, such as if there is an expectation that the committee may grow in size during its lifespan.  
    \end{enumerate}
    ...
    \end{enumerate}
  \end{enumerate}
  \item The initial composition of the committee shall be determined by one of the following processes:  
  \begin{enumerate}
    \item A complete slate of committee members may be passed through a special resolution which may be passed by acclamation or through a supermajority formal ballot item. The size of the fixed slate may differ from the fixed size chosen for ranked choice selection of members.  
    \item A ranked choice formal ballot item with STV vote counting may be used to determine committee membership. Candidates shall be any members who self-nominate and are seconded by another member, or who are nominated by another member and accept nomination.  
  \end{enumerate}
...
\begin{enumerate}
  \item A committee may use any informal procedure internally to add to its membership, subject to the maximum size of the committee, which shall be 8 individuals unless overridden through the collective organization.  
  \begin{enumerate}
    \item Should there be internal disagreement on the addition of a member to a committee, any member of the committee may present a written petition for a vote, which shall require a written majority of committee members to support the addition of the member, subject to enforcement by the officers of the organization.  
  \end{enumerate}
  \item Members may leave a committee voluntarily through written notice.  
  \begin{enumerate}
    \item The minimum size of a committee shall be 2 individuals. If at any point this is violated, the committee is dissolved immediately.  
  \end{enumerate}
  \item A committee may remove a member through the written consent of a supermajority of other members of the committee, with the written consent of a supermajority of officers.  
  \begin{enumerate}
    \item The minimum size of a committee shall be 2 individuals. If at any point this is violated, the committee is dissolved immediately.  
  \end{enumerate}
  ...
  \begin{enumerate}
    \item The maximum size of a committee, up to no more than 16 members.  
  ...
  \begin{enumerate}
    \item The membership of a committee.  
...
\begin{enumerate}
  \item An open committee meeting shall be defined as a meeting at which a committee is present and which all members may attend as a right of membership.  
  \item Committees must schedule their first open committee meeting within 7 days of the committee's formation, if reasonably possible.  
  \item Committees must schedule open committee meetings no further than 21 days from the previous open committee meeting at which they were present if the committee has already conducted one or more open meetings, if reasonably possible.  
  \item Multiple committees may conduct joint open committee meetings, if individuals will have a reasonable opportunity to engage fully with each committee present.  
  \item Open committee meetings must, at minimum, be announced in such a manner that it can be reasonably expected that any member of (i) one or more relevant interest groups or (ii) any member of the collective organization will be aware of the time and location of the meeting.
\end{enumerate}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item If an existing committee is part of a proposed interest group, a member of the committee must affirm the committee's interest in, and capability to, administer the interest group.  
  \end{enumerate}
...
A formal vote shall be defined as an anonymous process to decide one or more questions through an in-person election. Formal votes shall occur following COMs as required, as well as for general and special elections of officers. This definition is duplicated in section 2 ("definitions").
...
\begin{enumerate}
  ...
  \end{enumerate}
  \item Each ballot item on a formal vote's ballot shall have an associated minimum notice period. The voting board must ensure an announcement of the ballot item's contents is made prior to this notice period in a manner which all voting members can reasonably be expected to see.  
  \item Formal votes must occur on CMU's campus.  
  \item During a formal vote, a ballot box must be located in a reserved publicly accessible space for a minimum voting period of six hours, which must include at least one hour between 9 AM and 5 PM, and at least 1.5 hours between 5 PM and 7 PM. The ballot box must be watched at all times by one or more members of the voting board, and any voting member shall have the right to watch the ballot box.  
...
\begin{enumerate}
  \item A simple resolution to propose an amendment must be passed through the collective organization.  
  \begin{enumerate}
    \item The resolution must contain the precise text of the amended bylaws, or of all sections to be altered.  
  \end{enumerate}
  \item Following this resolution, a formal vote must be scheduled to contain a supermajority ballot item to ratify the amendment. The ballot item must have a minimum notice period of 6 days, and must not occur further than 21 days from the passing of the resolution, unless no sooner time would be permitted.  
  \begin{enumerate}
    \item The ballot item must contain the precise text of the amendment as written in the resolution proposing the amendment.  
  \end{enumerate}
...
\begin{enumerate}
  ...
  \item Following this resolution, a formal vote must be scheduled to contain a supermajority ballot item to ratify the dissolution. The ballot item must have a minimum notice period of 6 days, and must not occur further than 21 days from the passing of the resolution, unless no sooner time would be permitted.  
...
\begin{enumerate}
  ...
  \item No property of the organization nor any of its monetary assets shall be distributed to any members of the organization. After payment of the debts of the organization, its property and monetary assets must be distributed to one or more charities or organizations of similar purpose, as determined by resolutions passed prior to dissolution, which may designate an individual or group as having the right to resolve any such matters.
\end{enumerate}
