...
There may be multiple clerks at any given time. Clerks are responsible for chairing and overseeing collective organization meetings, with the objective of neutrally conducting business and giving all attendees an equitable chance to be heard. Clerks are also responsible for ensuring minutes are taken at such meetings. The minutes-taker(s) must take care to record discussion in a neutral manner.
...
\begin{enumerate}
  \item General elections, during which all officer positions are filled.  
  \begin{enumerate}
    ...
    \begin{enumerate}
      \item Individuals shall assume their officer positions at the start of the spring semester.  
    \end{enumerate}
    ...
    \begin{enumerate}
      \item Individuals shall typically assume their officer positions at the start of the summer 1 semester, unless both the newly elected individual and the current officer board consent to deferring to no later than the first day of the upcoming fall semester.  
    \end{enumerate}
...
\begin{enumerate}
  ...
  \end{enumerate}
  \item Officer positions shall be decided in the order they are listed in section 4.2 ("officer positions"). No individual may ordinarily hold more than one officer position, with the exception of clerk and a single other position.  
...
\begin{enumerate}
  ...
  \item A supermajority resolution may be passed by the collective organization with a minimum notice period of 3 days, scheduled no more than 7 days from the introduction of the proposed resolution if reasonably possible.
\end{enumerate}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \end{enumerate}
    \item Optionally, a clause increasing the maximum size of the committee's membership, which may be no more than 16 individuals. Such a clause requires (i) the resolution to pass by a supermajority formal vote, or (ii) a separate resolution to pass by a supermajority formal vote, such that the committee creation resolution may be passed by a majority.  
    \begin{enumerate}
    ...
    \item Optionally, a clause increasing the maximum duration of the committee's lifespan, which shall be no more than 365 days. Such a clause requires (i) the resolution to pass by a supermajority formal vote, or (ii) a separate resolution to pass by a supermajority formal vote, such that the committee creation resolution may be passed by a majority.  
    \begin{enumerate}
...
\begin{enumerate}
  ...
  \item A committee may opt to change its lifespan, subject to a maximum lifespan of 42 days, unless overridden through the collective organization.  
...
\begin{enumerate}
  \item Revision 1.0: September 29, 2025
\end{enumerate}
